                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        @if ($shipment_history->count())
                            ...
                            <a href="https://g.page/r/CQ0o4MA3-fPEEB0/review" target="_blank" button class="btn btn-text plus float-right" type="button" style="margin-top: 2rem; padding: 10px; background-color: #D03232; color: #fff; border: none;">
                                	Review Us
                                	</button>
                              	</a>
                                ...
                                <div style="margin-top: 1rem;">
                                    <table class="table table-dark">
                                        <tbody>
                                          <tr>
                                            <th>Shipper</th>
                                            <td>{{ $latest_shipment->shipper }}</td>

                                            <th>Origin</th>
                                            <td>{{ $latest_shipment->origin }}</td>
                                          </tr>

                                          <tr>
                                            <th>Consignee</th>
                                            <td>{{ $latest_shipment->consignee }}</td>

                                            <th>Destination</th>
                                            <td>{{ $latest_shipment->destination }}</td>
                                          </tr>

                                          <tr>
                                            <th>Service</th>
                                            <td>{{ $latest_shipment->service }}</td>

                                            <th>Tracking No.</th>
                                            <td>{{ $latest_shipment->marking_number }}</td>
                                          </tr>

                                          <tr>
                                            <th>Collie</th>
                                            <td>  {{ $latest_shipment->dimension }}</td>

                                            <th>Weight</th>                                                        
                                            <td>  {{ $latest_shipment->weight }}</td>
                                          </tr>

                                          <tr>
                                            <th>Pick Up Date</th>
                                            <td>{{ $latest_shipment->pickup_date }}</td>
                                            
                                            <th>Volume</th>
                                            <td>{{ $latest_shipment->volume }}</td>
                                          </tr>
                                                        
                                          <tr>              
                                            <th>ETD</th>
                                            <td>{{ $latest_shipment->actual_delivered_date }}</td>
                                            
                                            <th>ETA</th>
                                            <td>{{ $latest_shipment->delivery_date }}</td>
                                          </tr>
